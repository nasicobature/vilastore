...
function appendMessage(message, isOwn, senderType) {
  ...
  const avatarIcon = senderType === 'seller' ? 'house' : (senderType === 'system' ? 'info' : 'user');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const publicId = layout.getAttribute('data-inquiry');
  ...
  function sendMessage() {
    ...
    fetch(`/marketplace/housing-inquiry/${publicId}/message/`, {
      method: 'POST',
