...
urlpatterns = [
    ...
    path('secondary/salary-vouchers/create/', views.secondary_create_salary_voucher, name='secondary_create_salary_voucher'),
    path('secondary/salary-vouchers/<int:voucher_id>/approve/', views.secondary_approve_salary_voucher, name='secondary_approve_salary_voucher'),
    path('secondary/salary-vouchers/process/', views.secondary_process_salary_vouchers, name='secondary_process_salary_vouchers'),
